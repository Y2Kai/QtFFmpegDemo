...
class PlayImage : public QOpenGLWidget, public  QOpenGLFunctions_4_5_Core
#endif
{
    Q_OBJECT
public:
...
private:
    ...
    void initScreenProgrammer();
    void initFBOProgrammer();

    void initFBO(AVFrame *frame);
	void initFBO(int w, int h);
    void drawFBO();

	void initTextYUV420P_2(AVFrame* frame);
	void initTextYUV420P_2(int w ,int h);
...
private:
    ...
    bool m_isCreateFBO = false;

     QOpenGLTexture *m_QtextureFBO;
